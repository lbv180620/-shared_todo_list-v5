        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item <?= $active === 'top' ? 'active' : '' ?>">
                    <a class="nav-link" href="<?= Common::h(TOP_PAGE_URL) ?>">作業一覧 <span class="sr-only">(current)</span></a>
                </li>
                ...
                <li class="nav-item dropdown <?= $active === 'show' ? 'active' : '' ?>">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="<?= Common::h(SHOW_PAGE_URL) ?>?login_id=<?= Common::h($login['id']) ?>">マイページ</a></li>
                        <li><a class="dropdown-item" href="<?= Common::h(MEMO_PAGE_URL) ?>?login_id=<?= Common::h($login['id']) ?>">メモ</a></li>
                        <li>
                            <form action="<?= Common::h(LOGOUT_PAGE_URL) ?>" method="post" onsubmit="return checkLogout()" style="display: inline;">
                                <button type="submit" class="btn btn-danger dropdown-item">ログアウト</button>
                            </form>
                        </li>
                        <li><a class="dropdown-item" href="<?= Common::h(CANCEL_PAGE_URL) ?>?login_id=<?= Common::h($login['id']) ?>">退会</a></li>
                    </ul>
                </li>
            </ul>
